...
public class AimpActivity extends Activity {
    ...
    public void updateSongList() {
        ...
        if (home.listFiles(new Mp3Filter()).length > 0) {
                ...
                ListView lv=(ListView)findViewById(R.id.listsong);
    ...
    private void setImage(String name) {
        if(type == 0){
            ...
            if(imageResource != 0){
                ...
                int defaultImageResource = getResources().getIdentifier("drawable/headphone", null, getPackageName());
